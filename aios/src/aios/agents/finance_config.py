...
FINANCE_CONFIG = DomainConfig(
    ...
    sensors=[("leggi_conversioni", {}), ("leggi_revenue", {}),
             ...
             ("leggi_suite", {}), ("leggi_fatture", {}), ("leggi_giornale", {}),
             ("leggi_organico", {})],
    system=(
        ...
        "1 general_ledger[D] (libro giornale: scritture, riconcilia costi↔ricavi, voci non quadrate) · "
        "2 accounts_payable[D] (scadenze/pagamenti fornitori da costi) · "
        "3 accounts_receivable[D] (fatture scadute/non incassate >30gg → solleciti) · "
        ...
        "10 payroll[D] (organico da employees; cedolino amministratore, INPS Gestione Separata ~26%) · "
