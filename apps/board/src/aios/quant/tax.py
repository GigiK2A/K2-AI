...
# Vendorizzato nel board: la tabella grounding vive accanto al modulo (quant/grounding/).
_TABLES_PATH = pathlib.Path(__file__).resolve().parent / "grounding" / "tax-tables-fiscale.json"
