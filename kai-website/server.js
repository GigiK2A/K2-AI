...
const SECURITY_HEADERS = {
  'Content-Security-Policy': "default-src 'self'; base-uri 'self'; frame-ancestors 'self'; form-action 'self' https://*.clerk.accounts.dev https://*.accounts.dev https://*.clerk.com; object-src 'none'; script-src 'self' 'unsafe-inline' https://*.clerk.accounts.dev https://*.accounts.dev https://*.clerk.com https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https: wss://*.clerk.accounts.dev wss://*.accounts.dev wss://*.clerk.com; frame-src 'self' https://*.clerk.accounts.dev https://*.accounts.dev https://*.clerk.com https://challenges.cloudflare.com; media-src 'self' data: https:; worker-src 'self' blob:; upgrade-insecure-requests",
