...
description: >-
  ...
  "strategia parole chiave", "content cluster", "topic cluster", "semantic SEO",
  "LSI keywords", "pillar page", "silos SEO". Input: URL sito, settore, 3-5 keyword seed, 1-3 competitor
...
- `references/semantic-seo-clusters.md` — LSI keywords, content cluster pillar/cluster, content silos fisici e virtuali, intent mapping 4-way con esempi italiani per settore, metodo operativo per clusterizzare 50-100 keyword in pillar + satelliti
