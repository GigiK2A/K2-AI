...
async function main() {
  ...
  const imageRels = images
    ...
    : [];
  // schedule.json va incluso: markBlogPublished scrive il file ma senza
  // commit qui la modifica non arriva su origin e il bot ripescherebbe
  // la stessa riga al run successivo.
